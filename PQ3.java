...
public class PQ3 extends JFrame {
    ...
    public PQ3 () {
        ...
        JPanel panel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                ImageIcon background = new ImageIcon("PQ3.png"); // Provide the path to your image
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new PQ3().setVisible(true));
    }
