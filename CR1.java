...
public class CR1 extends JFrame {
    ...
    public CR1() {
        ...
        JPanel panel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                ImageIcon background = new ImageIcon("cr1.png"); // Provide the path to your image
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new CR1().setVisible(true));
    }
