...
public class PQ1 extends JFrame {
    ...
    public PQ1() {
        ...
        JPanel panel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                ImageIcon background = new ImageIcon("PQ1.png"); // Provide the path to your image
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new PQ1().setVisible(true));
    }
