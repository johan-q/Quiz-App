...
public class CssAverage1 extends JFrame {
    ...
    public CssAverage1() {
        ...
        JPanel panel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                ImageIcon background = new ImageIcon("CssAverage1.jpg"); // Provide the path to your image
    ...
    static class Check extends JFrame {
        public Check() {
            ...
            JAVAQ4.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    // Close the current frame
                    new CssAverage2().setVisible(true);
    ...
    static class CssAverage2 extends JFrame {
        ...
        public CssAverage2() {
            ...
            JPanel panel = new JPanel() {
                ...
                protected void paintComponent(Graphics g) {
                    super.paintComponent(g);
                    ImageIcon background = new ImageIcon("CssAverage2.jpg"); // Provide the path to your image
                    g.drawImage(background.getImage(), 0, 0, getWidth(), getHeight(), null);
                }
            };
            panel.setLayout(null); // Use absolute layout
        ...
        static class Check2 extends JFrame {
            public Check2() {
                ...
                JAVAQ4.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        // Close the current frame
                        new CssAverage3().setVisible(true);
                        // Open the Homepage frame
                        dispose();
                    }
                });
        ...
        static class CssAverage3 extends JFrame {
            ...
            public CssAverage3() {
                ...
                JPanel panel = new JPanel() {
                    ...
                    protected void paintComponent(Graphics g) {
                        super.paintComponent(g);
                        ImageIcon background = new ImageIcon("CssAverage3.jpg"); // Provide the path to your image
                        g.drawImage(background.getImage(), 0, 0, getWidth(), getHeight(), null);
                    }
                };
                panel.setLayout(null); // Use absolute layout
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> new CssAverage1().setVisible(true));
    }
}
    }
