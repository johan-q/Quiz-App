...
public class PhytonAverage extends JFrame {

    public PhytonAverage() {
        // Set up the JFrame
        setTitle("Java Play");
        ...
        JPanel panel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                ImageIcon background = new ImageIcon("PhytonAverage1.jpg"); // Provide the path to your image
    ...
    static class Check extends JFrame {
        public Check() {
            ...
            JAVAQ4.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    // Close the current frame
                    new PythonAverage2().setVisible(true);
    ...
    static class PythonAverage2 extends JFrame {

        public PythonAverage2() {
            // Set up the JFrame
            setTitle("Java Play");
            setSize(800, 600); // Match the size of the other frames
            setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
            ...
            JPanel panel = new JPanel() {
                ...
                protected void paintComponent(Graphics g) {
                    super.paintComponent(g);
                    ImageIcon background = new ImageIcon("PythonAverage2.jpg"); // Provide the path to your image
                    g.drawImage(background.getImage(), 0, 0, getWidth(), getHeight(), null);
                }
            };
            panel.setLayout(null); // Use absolute layout
        ...
        static class Check2 extends JFrame {
            public Check2() {
                ...
                JAVAQ4.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        // Close the current frame
                        new PythonAverage3().setVisible(true);
                        // Open the Homepage frame
                        dispose();
                    }
                });
        ...
        static class PythonAverage3 extends JFrame {

            public PythonAverage3() {
                // Set up the JFrame
                setTitle("Java Play");
                setSize(800, 600); // Match the size of the other frames
                setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
                ...
                JPanel panel = new JPanel() {
                    ...
                    protected void paintComponent(Graphics g) {
                        super.paintComponent(g);
                        ImageIcon background = new ImageIcon("PythonAverage3.jpg"); // Provide the path to your image
                        g.drawImage(background.getImage(), 0, 0, getWidth(), getHeight(), null);
                    }
                };
                panel.setLayout(null); // Use absolute layout
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> new PhytonAverage().setVisible(true));
    }
}
    }
