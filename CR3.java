...
public class CR3 extends JFrame {
    ...
    public CR3() {
        ...
        JPanel panel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                ImageIcon background = new ImageIcon("CR3.png"); // Provide the path to your image
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new CR3().setVisible(true));
    }
