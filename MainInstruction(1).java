...
public class MainInstruction extends JFrame {

    public MainInstruction() {
        // Set up the JFrame
        setTitle("Main Instruction");
        ...
        JPanel panel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                ImageIcon background = new ImageIcon("Main Inst.png"); // Provide the path to your image
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> new MainInstruction().setVisible(true));
    }
}
