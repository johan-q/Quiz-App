...
public class JvAverage1 extends JFrame {
    ...
    public JvAverage1() {
        ...
        JPanel panel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                ImageIcon background = new ImageIcon("JvAverage1.jpg"); // Provide the path to your image
    ...
    static class Check extends JFrame {
        public Check() {
            ...
            JAVAQ4.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    // Close the current frame
                    new JvAverage2().setVisible(true);
    ...
    static class JvAverage2 extends JFrame {
        ...
        public JvAverage2() {
            ...
            JPanel panel = new JPanel() {
                ...
                protected void paintComponent(Graphics g) {
                    super.paintComponent(g);
                    ImageIcon background = new ImageIcon("JvAverage2.jpg"); // Provide the path to your image
                    g.drawImage(background.getImage(), 0, 0, getWidth(), getHeight(), null);
                }
            };
            panel.setLayout(null); // Use absolute layout
        ...
        static class Check2 extends JFrame {
            public Check2() {
                ...
                JAVAQ4.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        // Close the current frame
                        new JvAverage3().setVisible(true);
                        // Open the Homepage frame
                        dispose();
                    }
                });
        ...
        static class JvAverage3 extends JFrame {
            ...
            public JvAverage3() {
                ...
                JPanel panel = new JPanel() {
                    ...
                    protected void paintComponent(Graphics g) {
                        super.paintComponent(g);
                        ImageIcon background = new ImageIcon("JvAverage3.jpg"); // Provide the path to your image
                        g.drawImage(background.getImage(), 0, 0, getWidth(), getHeight(), null);
                    }
                };
                panel.setLayout(null); // Use absolute layout
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> new JvAverage1().setVisible(true));
    }
}
    }
