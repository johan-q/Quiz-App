...
public class JavaAverage extends JFrame {
    ...
    public JavaAverage() {
        ...
        JPanel panel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                ImageIcon background = new ImageIcon("JavaAverage1.jpg"); // Provide the path to your image
    ...
    static class Check extends JFrame {
        public Check() {
            ...
            JAVAQ4.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    // Close the current frame
                    new JavaAverage2().setVisible(true);
    ...
    static class JavaAverage2 extends JFrame {
        ...
        public JavaAverage2() {
            ...
            JPanel panel = new JPanel() {
                ...
                protected void paintComponent(Graphics g) {
                    super.paintComponent(g);
                    ImageIcon background = new ImageIcon("JavaAverage2.jpg"); // Provide the path to your image
                    g.drawImage(background.getImage(), 0, 0, getWidth(), getHeight(), null);
                }
            };
            panel.setLayout(null); // Use absolute layout
        ...
        static class Check2 extends JFrame {
            public Check2() {
                ...
                JAVAQ4.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        // Close the current frame
                        new JavaAverage3().setVisible(true);
                        // Open the Homepage frame
                        dispose();
                    }
                });
        ...
        static class JavaAverage3 extends JFrame {
            ...
            public JavaAverage3() {
                ...
                JPanel panel = new JPanel() {
                    ...
                    protected void paintComponent(Graphics g) {
                        super.paintComponent(g);
                        ImageIcon background = new ImageIcon("JavaAverage3.jpg"); // Provide the path to your image
                        g.drawImage(background.getImage(), 0, 0, getWidth(), getHeight(), null);
                    }
                };
                panel.setLayout(null); // Use absolute layout
